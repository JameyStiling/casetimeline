...
export const TimelineView: React.FC<TimelineViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full relative overflow-hidden">
      {/* Top Toolbar */}
      <div className="flex items-center justify-between gap-4 py-4 px-8 bg-[#0e1423] border-b border-border-color shrink-0 flex-wrap">
        <div className="flex items-center gap-4 flex-1 min-w-[280px]">
          <div className="relative flex-1 flex items-center">
            ...
            <input
              ...
              placeholder="Search timeline facts, descriptions, or source documents..."
              value={searchText}
